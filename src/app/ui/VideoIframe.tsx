...
export default function VideoIframe({
  ...
  }, [boundry, isVisible, isPaused, isMounted]);
  ...
  //   if (mainElement && isMounted && isVisible) {
  ...
  //     );
  //   }
  // }, [step, video, isMounted, isVisible]);
  ...
  useGSAP(
    () => {
      ...
      tlRef.current.set(containerRef, { scale: 1 });
      if (main && isVisible)
    ...
    { scope: containerRef, dependencies: [step, isMounted, isVisible] },
  );
