    ...
    <div className="relative flex h-full w-full items-center justify-center p-8 pt-[120px]">
      {!array || array?.length === 0 ? (
        ...
        <>
          ...
          <div className="relative flex h-full max-h-[500px] w-full max-w-[440px] min-w-[320px] scale-[0.7] items-center justify-center sm:scale-[0.8] lg:scale-[0.9] xl:scale-[1]">
            {/* Replace background div with Image component */}
            <Image
              ref={containerRef}
              src={srcImage[0]}
              alt="background"
